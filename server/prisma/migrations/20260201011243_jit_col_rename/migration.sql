/*
  ...
  - You are about to drop the column `jit` on the `RefreshToken` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "RefreshToken_jit_key";

-- AlterTable
ALTER TABLE "RefreshToken" DROP COLUMN "jit",
